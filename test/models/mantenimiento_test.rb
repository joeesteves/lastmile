...
class MantenimientoTest < ActiveSupport::TestCase
  ...
  test 'detalle' do
    ...
    assert_equal 1, detalle.length, 'array no tiene el tamaño correcto'
  ...
  test 'orden primero maquina y luego implementos' do
    detalle = Mantenimiento.detalle('fumigadoras')
    assert_equal 'mosquito', detalle[0]["maquina"]
    assert_equal 'aguatero', detalle[1]["maquina"]
